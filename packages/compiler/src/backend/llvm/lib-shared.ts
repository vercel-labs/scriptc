...
export const LIB_FN_SYMS: Record<string, string> = {
  ...
  "child.inputWritable": "scr_child_input_writable",
  "child.inputWrite": "scr_child_input_write",
  "child.inputWriteBytes": "scr_child_input_write_bytes",
  "child.inputEnd": "scr_child_input_end",
  "child.inputEndBytes": "scr_child_input_end_bytes",
  "child.inputDestroy": "scr_child_input_destroy",
