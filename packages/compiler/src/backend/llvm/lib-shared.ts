...
export const LIB_FN_SYMS: Record<string, string> = {
  ...
  "number.isFiniteDyn": "scr_num_is_finite_dyn",
  "number.isNaNDyn": "scr_num_is_nan_dyn",
  "number.isIntegerDyn": "scr_num_is_integer_dyn",
  "number.isSafeIntegerDyn": "scr_num_is_safe_integer_dyn",
  ...
  "process.version": "scr_process_version",
  ...
  "crypto.hashDigestBytesBuf": "scr_crypto_hash_digest_bytes_buf",
  "crypto.timingSafeEqual": "scr_crypto_timing_safe_equal",
  "process.memoryUsageRss": "scr_process_memory_rss",
  "process.memoryUsageHeapTotal": "scr_process_memory_heap_total",
  "process.memoryUsageHeapUsed": "scr_process_memory_heap_used",
  ...
  "net.isIP": "scr_net_is_ip",
  "net.isIPv4": "scr_net_is_ipv4",
  "net.isIPv6": "scr_net_is_ipv6",
