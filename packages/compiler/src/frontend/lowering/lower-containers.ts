 ...
 * methods with Node-exact forEach desugaring, iterator helpers, and indexed
 * record operations. */
  ...
  function reduceHelper(lowerer: Lowerer, method: "reduce" | "reduceRight",
    ...
    const seedStmts: IrStmt[] = [
      ...
      ...(hasInit
        ...
        : [
            { kind: "while", cond: { kind: "ternary", cond: inRange, then: { kind: "unary", op: "!", operand: currentArrayIndexPresent(arrT, loc), type: BOOL, loc }, else_: boolLit(false, loc), type: BOOL, loc }, body: [advance], loc },
    ...
    const loop: IrStmt = {
      ...
      body: [{ kind: "if", cond: currentArrayIndexPresent(arrT, loc), then: [
        {
          kind: "assign",
          localId: "acc.0",
